...
import Star_dark_green from './star_dark_green';
import Star_teal_blue from './star_teal_blue';
import Star_pink_blue from './star_pink_blue';
import Star_pink_red from './star_pink_red';
...
class DetailedExpansionPanel extends Component {
    state = {
      ...
      visitedSite = () => {
        this.props.changeVisit_user();
      };

    componentDidMount() {
      
      const { keepContent_user } = this.props
      if(keepContent_user) {
        ...
        return (
            ...
            { props => (
                ...
                >
                  ...
                  {
                    (val1_ < 0.04 && val1_ >= 0.02)?
                    <div>
                    this should be Star_pink_blue
                    <Star_pink_blue
                      val = {val1_}
                      type = 'user'
                      />
            ...
            <Spring
              ...
              from={{ opacity: 0 }}
              to={{opacity: 1 }}
              config={{ delay: 5500, duration: 500 }}
              > 
              { props => (
                  <div style={props}>
              <ExpansionPanel >
